...
def get_version():
    ...
    version_file = os.path.join(current_dir, "llmgt", "__init__.py")
    with io.open(version_file, encoding="utf-8") as f:
        return re.search(r'^__version__ = [\'"]([^\'"]*)[\'"]', f.read(), re.M).group(1)


setuptools.setup(
    name="financial-behavior-simulation",
    version=get_version(),
    author="",
    license="Apache-2.0",
    ...
    url="https://github.com/AgenticFinLab/lmafb",
    ...
    keywords="Financial behaviors, Simulation, Multi-agents, LLMs",
)
