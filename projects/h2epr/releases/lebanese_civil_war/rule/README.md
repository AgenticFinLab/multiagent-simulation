...
custody locator:
`.local-runtime/h2epr-simulation/runs/benchmark/lebanese_civil_war/rule/2026-09-07-four-task-maintenance/materialization-a`.
...
`development_samples_v1/events/H2EPR-0892/` files pinned by the
...
PYTHONPATH=projects/h2epr/src python -B -m h2epr.cli materialize \
  ...
  --custody-locator .local-runtime/h2epr-simulation/runs/benchmark/lebanese_civil_war/rule/2026-09-07-four-task-maintenance/reproduction \
  --output .local-runtime/h2epr-simulation/runs/benchmark/lebanese_civil_war/rule/2026-09-07-four-task-maintenance/reproduction
```
