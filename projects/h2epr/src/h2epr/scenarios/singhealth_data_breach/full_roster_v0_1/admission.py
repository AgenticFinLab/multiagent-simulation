"""Fail-closed admission for SingHealth full-roster Policy Realization."""
...
CONFIGURATION_RELEASE_MANIFEST_PATH = Path(
    "configs/singhealth_data_breach/scenario-configuration-v0.1/manifest.json"
)
...
CONFIGURATION_ADMISSION_RECEIPT_SHA256 = (
    "2ba6e893178ec16158acfd774ff0db36f21d4fd65b9a9049bd6e566f24e04cc9"
)
CONSOLIDATED_MAPPING_MANIFEST_PATH = Path(
    "agents/bindings/singhealth_data_breach/consolidated/manifest.json"
)
CONSOLIDATED_MAPPING_MANIFEST_SHA256 = (
    "7a603d97bb25f8dddab08d7a8865fd6305a94e4db108f5f32b8ad65d28695bb9"
)
SCENARIO_RELEASE_MANIFEST_PATH = Path(
    "scenarios/singhealth_data_breach/definition-v0.1/manifest.json"
)
SCENARIO_RELEASE_MANIFEST_SHA256 = (
    "948b9ba9e29ba6947abefd65663bd4e9ef1ff47ebb1f465a08524378b20b8795"
)
...
def _validate_participants(
    document: Mapping[str, Any],
    catalog: SingHealthPolicyCatalog,
...
def load_singhealth_policy_realization(
    realization_path: str | Path,
    *,
    expected_source_sha256: str | None,
    project_root: str | Path | None = None,
) -> PolicyRealizationAdmission:
    """Validate one candidate or accepted SingHealth Policy Realization."""
    ...
    except SingHealthPolicyCatalogError as exc:
        _fail(
            PolicyRealizationErrorCode.PARENT_MISMATCH,
            pointer="/semantic_parent",
            detail=str(exc),
...
def expected_singhealth_semantic_parent() -> Mapping[str, Any]:
