...
CONFORMANCE_ID = "h2epr.cross-event.execution-conformance.v0_1"
RELEASE_ID = "H2EPR-CROSS-EVENT-EXECUTION-CONFORMANCE-v0.1"
RELEASE_VERSION = "0.1.0"
RELEASE_STATUS = "accepted_two_event_execution_conformance"
RELEASE_PATH = Path("execution/cross-event-conformance-v0.1")
...
class CrossEventConformanceCode(str, Enum):
    """Stable fail-closed classes for the two-event closeout release."""
...
class CrossEventConformanceAdmission:
    """Immutable result of admitting the two-event closeout release."""
...
def build_cross_event_conformance(
    *,
    ...
    """Build the compact comparison from both accepted event releases."""
    ...
    return {
        "format_identity": "h2epr.cross-event-execution-conformance.v0_1",
...
def build_cross_event_release_manifest(
    ...
    *,
    ...
    return {
        ...
        "claim_boundary": dict(CLAIM_BOUNDARY),
        "endpoint": {
            "two_event_rule_execution_closed": True,
...
def load_cross_event_conformance_release(
    ...
    *,
    ...
    """Admit the compact two-event release from its accepted parents."""
