...
| Participant models | [Panic of 1907 Agent Definitions and linked Population Models](../../agents/defines/panic_1907/) | Seven institutional decision interfaces and five heterogeneous choice-unit models |
...
|---|---|---|
| Participant inventory | [Roster Definition release v0.1](../../releases/panic_1907/roster-definition-v0.1/) | Exact seven-Agent and five-Population semantic input inventory |
...
| Versioned semantic packages | [Event Scenario Definition v0.1](../../scenarios/panic_1907/definition-v0.1/) and [Scenario Configuration v0.1](../../configs/panic_1907/scenario-configuration-v0.1/) | Manifests, reviews, and integrity records for the accepted semantic inputs |
