...
| `H2EPR-0481`, Samsung Galaxy Note7 Battery Recall Crisis | [samsung_note7_battery_recall](samsung_note7_battery_recall/README.md) | Third-event Frame and hash-pinned Roster Definition release accepted; consolidated mapping and Event Scenario Definition are next. |
