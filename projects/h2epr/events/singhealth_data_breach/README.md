...
[participant interface](../../agents/interfaces/singhealth_data_breach/) projects four
...
authority and reducer. It keeps retrospective Whitefly attribution unavailable
to earlier actors and rejects malformed Draft relation/penalty endpoints as
...
The canonical seed-0 run is `run.5db9a323beb010817c521f46`: eight actors, 20 coordinates,
782 trace records,
819 graph nodes and
2,317 edges. Fresh A/B, generated-ID perturbation,
...
A missing-scope probe and delayed-findings probe demonstrate valid open endpoints
under changed information while preserving execution integrity. Raw custody is
