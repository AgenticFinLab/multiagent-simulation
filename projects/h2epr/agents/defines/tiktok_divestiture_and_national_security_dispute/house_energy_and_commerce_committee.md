# House Energy and Commerce Committee Agent Definition

## 1. Model overview

| Field | Account |
|---|---|
| Semantic parent | `h2epr.0170.agent.house_energy_and_commerce_committee.v1` |
| Actor ID | `house_energy_and_commerce_committee` |
| Benchmark | H2EPR-0170, 2020-08-06 through the Draft's qualified 2025-09-15 negotiation and grace-extension endpoint |
| Representation | agent; the represented public-hearing convening interface |
| Source ID | `P_7` |
| Primary choices | Convene the TikTok oversight hearing and issue hearing invitations to ByteDance and Chew. |
...
P_7 appears once as the House committee. Its current choice is the hearing record and invitation, not the testimony or any later congressional bill.

The committee cannot speak for Chew, designate him for ByteDance, pass Congress-wide legislation, decide court outcomes, or establish national-security truth. The parent fixes no calibrated utility, personality,
...
Frozen anchors: SRC006. The Draft's sole E5 relation omits the committee as testimony recipient. Current semantics preserve the committee as convener and recipient while P_6 owns testimony.
...
This agent may convene the TikTok oversight hearing and issue hearing invitations to ByteDance and Chew. It cannot act as another producer,
...
A convened hearing does not guarantee witness attendance, testimony, legislative passage or a substantive finding.
...
The hearing waits for the exposed restriction/proposal context. Delivery failure leaves designation/testimony open and must remain visible. Memory persists across this bounded event without a
...
| --- | --- | --- |
| `convene_tiktok_hearing` | known `anti_tiktok_proposal_record` from `state_and_legislative_restriction_population`; known `federal_device_directive_record` from `joe_biden_executive_interface` | Record the represented oversight hearing after restriction/proposal context and send separate invitations; convening does not produce testimony. |
...
| --- | --- | --- |
| `convene_tiktok_hearing` | `oversight` | `oversight.house_hearing`: unrecorded → `convened_recorded` |
...
- Normal: The committee records the hearing and sends separate notices to the organization and named witness.
- Missing information: The hearing waits for the exposed restriction/proposal context. Delivery failure leaves designation/testimony open and must remain visible.
...
- Authority/adverse case: A convened hearing does not guarantee witness attendance, testimony, legislative passage or a substantive finding.
- Perturbation: Withholding one invitation prevents the corresponding downstream record without creating a substitute hearing outcome.
...
The committee cannot speak for Chew, designate him for ByteDance, pass Congress-wide legislation, decide court outcomes, or establish national-security truth. The Draft's sole E5 relation omits the committee as testimony recipient. Current semantics preserve the committee as convener and recipient while P_6 owns testimony.
