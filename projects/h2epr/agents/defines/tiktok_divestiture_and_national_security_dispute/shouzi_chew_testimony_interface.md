# Shouzi Chew Testimony Interface Agent Definition

## 1. Model overview

| Field | Account |
|---|---|
| Semantic parent | `h2epr.0170.agent.shouzi_chew_testimony_interface.v1` |
| Actor ID | `shouzi_chew_testimony_interface` |
| Benchmark | H2EPR-0170, 2020-08-06 through the Draft's qualified 2025-09-15 negotiation and grace-extension endpoint |
| Representation | agent; Chew's represented public testimony at the House committee hearing |
| Source ID | `P_6` |
| Primary choices | Deliver the bounded testimony record after receiving both the hearing invitation and ByteDance designation. |
...
P_6 appears once as TikTok's CEO and witness. The named interface is separate from ByteDance's organizational decision to designate representation and from the committee's choice to convene.

Chew cannot convene the hearing, bind Congress or ByteDance beyond the represented testimony, establish data safety, decide legislation, or produce a legal result. The parent fixes no calibrated utility, personality,
...
Frozen anchors: SRC006. The E5 relation points ByteDance to Chew while describing testimony before the committee. Current routes make P_7 the inviter, P_2 the designator and P_6 the witness.
...
This agent may deliver the bounded testimony record after receiving both the hearing invitation and ByteDance designation. It cannot act as another producer,
...
Testimony is a public record, not proof that claims were accepted or that oversight, legislation or security concerns were resolved.
...
Without the committee invitation or ByteDance designation, the witness waits; neither a stage label nor public hearing state impersonates both messages. Memory persists across this bounded event without a
...
| --- | --- | --- |
| `deliver_house_testimony` | known `house_hearing_invitation` from `house_energy_and_commerce_committee`; known `bytedance_hearing_designation` from `bytedance_platform_governance_interface` | Record the represented testimony only after both invitation and designation are known; no claim acceptance is inferred. |
...
| --- | --- | --- |
| `deliver_house_testimony` | `oversight` | `oversight.ceo_testimony`: unrecorded → `qualified_testimony_recorded` |
...
- Normal: After both messages arrive, Chew records one testimony and publishes the qualified hearing record to the committee and Congress.
- Missing information: Without the committee invitation or ByteDance designation, the witness waits; neither a stage label nor public hearing state impersonates both messages.
...
- Authority/adverse case: Testimony is a public record, not proof that claims were accepted or that oversight, legislation or security concerns were resolved.
- Perturbation: An impossible or stale designation leaves testimony and testimony-dependent legislation open.
...
Chew cannot convene the hearing, bind Congress or ByteDance beyond the represented testimony, establish data safety, decide legislation, or produce a legal result. The E5 relation points ByteDance to Chew while describing testimony before the committee. Current routes make P_7 the inviter, P_2 the designator and P_6 the witness.
