# F. Augustus Heinze — Agent Definition

## 1. Model overview

| Field | Account |
|---|---|
| Semantic ID | `h2epr.0288.agent.heinze.v0.4` |
| Runtime actor | `heinze` |
| Benchmark event | Panic of 1907 (`H2EPR-0288`) |
| Source participant | `P_1` — F. Augustus Heinze (奥古斯都·海因策/Heinze) |
...
This semantic parent retains the participant as an autonomous action-bearing boundary because one or more Draft episodes assign it an exposed transition. No unobserved capital, intent, or private coordination is inferred.
