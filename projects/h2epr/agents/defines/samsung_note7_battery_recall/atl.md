...
| Field | Account |
|---|---|
| Semantic ID | `h2epr.0481.agent.atl.v0.4` |
| Runtime actor | `atl` |
| Benchmark event | Samsung Galaxy Note7 Battery Recall (`H2EPR-0481`) |
| Source participant | `P_6` — Amperex Technology Co., Limited (新能源科技有限公司, ATL) |
| Representation | `agent` |
| Event role | domestic-market battery supplier |
| Dataset exposure | Full Draft exposed; construction practice only |

## 2. Benchmark participant and representation

This semantic parent retains the participant as an autonomous action-bearing boundary because one or more Draft episodes assign it an exposed transition. Supplier testing, evidence, and private coordination are absent.
...
Role: domestic-market battery supplier.

Authority boundary: May express the declared domestic supply and public denial transitions.
...
- `entities.battery_supply.domestic_supplier`
- `entities.supplier_position.atl_battery_link`
