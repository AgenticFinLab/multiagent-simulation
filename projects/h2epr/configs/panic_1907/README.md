...
| [rule_canary_v1.json](rule_canary_v1.json) | frozen engineering reference | deterministic Rule runtime canary input |
| [compiler_canary_v1.json](compiler_canary_v1.json) | frozen engineering reference | sealed-trace compiler canary input |
...
[KT--NBC--NYCH binding](../../agents/bindings/panic_1907/kt-nbc-nych-v0.1/)
...
The separate [conformance closeout](../../scenarios/panic_1907/lineage-conformance-v0.1/)
