"""MASim Persona Layer - Infrastructure Coordination
...
Hierarchical Execution Model:
    ...
    - Player: turn (for loop calling step multiple times)
    - Player: step (atomic perceive→decide→act)
        ...
        if self._observability:
            ...
            await self._observability.record_metric(
                "cycle_completed",
                {
                    ...
                    "actions_processed": cycle_result.actions_processed,
                    "duration_ms": duration,
                },
            )
