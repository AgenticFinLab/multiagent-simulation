...
| Scenario Portability | 32 pool scenarios bound via `players.yml → market.archetype: stock-standard-price-impact`. **Full ✅**: AnchoringEffect, ArchegosCollapse, AssetBubble, AvailabilityBias, BlackMonday1987, ConfirmationBias, DispositionEffect, DotComBubble, EndowmentEffect, EquityPremium, FlashCrash, FlashCrash2010, FramingEffect, GameStopShortSqueeze, GamblerFallacy, HerdEffect, HerdingInformation, HindsightBias, LiquidityDryup, LossAversion, MarketCrash, MentalAccounting, MomentumEffect, OverconfidenceBias, RepresentativenessBias, ReversalEffect, ShortSqueeze, SouthSeaBubble, StatusQuoBias, SunkCostFallacy, TulipMania, VolatilityClustering. **Approximated ⚠**: (none — all 32 scenarios use this coordinator's verbatim mechanism signature). See also the Scenario Status row below. |
