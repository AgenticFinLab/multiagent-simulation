...
- For variant configs, the identity MUST also carry the variant prefix:
  ...
  `masim/agents/defines/finance/` and icon in
  `masim/agents/defines/agent_images/icons/`) are shared across variants; the
