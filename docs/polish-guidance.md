...
| Agent pool icons       | Every referenced AGENT_POOL profile resolves to a valid icon; missing or broken reused-profile icons are repaired via `agent-icon-generation-skill.md` |
...
| `masim/skills/agent-icon-generation-skill.md`      | Generates/registers icons for new, forked, or reused pool agents whose icon is missing or broken |
