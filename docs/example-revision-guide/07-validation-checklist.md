...
Verify each `Rule/analysis.py` produces a structured validation report. Run the analysis script and check its output against the requirements in `masim/format/implement-simulation-skill/08-step4-implement.md §4.1.4`.
