"""FlashCrashRag — RAG-augmented Rule+LLM Flash Crash Simulation
...
This extends the three-variant comparison:
    ...
    FlashCrashRuleLLM — LLM with rules in prompt (no external knowledge)
    FlashCrashRag     — LLM with rules in prompt + RAG knowledge retrieval
...
1. **Via Streamlit Web UI (Recommended):**
   ...
   ```
   Then select "FlashCrashRag" from the scenario dropdown.
...
# =============================================================================
# Market — Rule-Based Coordinator (identical to FlashCrashRuleLLM.Market)
# =============================================================================
...
class RagLLMInvestor(GeneralPlayer):
    """
    Base class for RAG-augmented Rule+LLM flash crash investors.
