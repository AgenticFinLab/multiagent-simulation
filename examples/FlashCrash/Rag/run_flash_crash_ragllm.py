#!/usr/bin/env python
"""FlashCrashRag Simulation Runner

Run RAG-augmented Rule+LLM flash crash investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run FlashCrashRag Simulation")
    parser.add_argument(
        "-c", "--config", type=str, default="configs/FlashCrash/Rag/simulation.yml"
    )
    ...
    print("\n" + "=" * 60)
    print("FlashCrashRag Simulation")
    print("=" * 60)
    print("Phenomenon: Flash Crash with RAG-Augmented LLM Decision-Making")
