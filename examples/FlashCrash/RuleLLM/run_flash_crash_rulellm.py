#!/usr/bin/env python
"""FlashCrashRuleLLM Simulation Runner

Run hybrid Rule+LLM flash crash investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run FlashCrashRuleLLM Simulation")
    parser.add_argument(
        "-c", "--config", type=str, default="configs/FlashCrash/RuleLLM/simulation.yml"
    )
    ...
    print("\n" + "=" * 60)
    print("FlashCrashRuleLLM Simulation")
    print("=" * 60)
    print("Phenomenon: Flash Crash with Rule-Guided LLM Decision-Making")
