...
meaningful comparison across three variants:
    ...
    ReversalEffectLLM     - pure LLM (persona only)
    ReversalEffectRuleLLM - hybrid (persona + explicit rules in prompt)
...
1. **Via Streamlit Web UI (Recommended):**
   ...
   ```
   Then select "ReversalEffectRuleLLM" from the scenario dropdown.
...
# =============================================================================
# Market - Rule-Based Coordinator (identical to ReversalEffect.Market)
# =============================================================================
...
class RuleLLMInvestor(GeneralPlayer):
    """
    Base class for hybrid Rule+LLM reversal effect investors.
