#!/usr/bin/env python
"""ReversalEffectRuleLLM Simulation Runner

Run hybrid Rule+LLM reversal effect investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run ReversalEffectRuleLLM Simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/ReversalEffect/RuleLLM/simulation.yml",
    )
    ...
    print("\n" + "=" * 60)
    print("ReversalEffectRuleLLM Simulation")
    print("=" * 60)
    print("Phenomenon: ReversalEffect with Rule-Guided LLM Decision-Making")
