...
| Name        | ReversalEffect                                                                                                                                  |
| Domain      | finance                                                                                                                                         |
| Phenomenon  | Extended overreaction driven by momentum and overconfidence eventually reverses as contrarian value investors enter with increasing conviction. |
...
|----------------------|-------------------------------------------------------|--------------------------------------------------------|-------------------|-------------------------------|------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|
| contrarian-investor  | long-horizon contrarian fund or reversal strategist   | Overreaction (§4.1) and Limits to Arbitrage (§4.5)     | Stabilising       | price, cumulative_return      | "Exists to fade extended trends by trading against the cumulative return direction."                                               | masim/agents/defines/finance/contrarian-trader.md   |
| momentum-investor    | momentum strategy fund or trend-following CTA         | Momentum (§4.2)                                        | Destabilising     | price, return                 | "Exists to sustain directional trends through positive-feedback trading, providing the deviation that reversal agents later fade." | masim/agents/defines/finance/momentum-trader.md     |
...
| value-investor       | value-oriented mutual fund or fundamental analyst     | Contrarian/Value (§4.4) and Limits to Arbitrage (§4.5) | Stabilising       | price, fundamental, deviation | "Exists to buy undervalued assets and sell overvalued ones, providing fundamental gravity."                                        | masim/agents/defines/finance/fundamental-analyst.md |
...
| noise-trader         | uninformed retail liquidity provider                  | Noise Trading (Black 1986 context)                     | Context-dependent | price, cash, position         | "Exists to add background liquidity and non-informational volatility."                                                             | masim/agents/defines/finance/noise-trader.md        |
