#!/usr/bin/env python
"""Reversal Effect Rag Simulation Analysis.
...
02_reversaleffect_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for ReversalEffect Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(description="Analyze ReversalEffect Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/ReversalEffect/Rag/simulation.yml",
    )
    ...
    summary = analyze_standard_scenario("ReversalEffect", data, config, output_dir)
