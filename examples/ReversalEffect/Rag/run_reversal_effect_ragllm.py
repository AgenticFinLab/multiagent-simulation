#!/usr/bin/env python
"""ReversalEffectRag Simulation Runner

Run RAG-augmented Rule+LLM reversal effect investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run ReversalEffectRag Simulation")
    parser.add_argument(
        "-c", "--config", type=str, default="configs/ReversalEffect/Rag/simulation.yml"
    )
    ...
    print("\n" + "=" * 60)
    print("ReversalEffectRag Simulation")
    print("=" * 60)
    print("Phenomenon: Reversal Effect with RAG-Augmented LLM Decision-Making")
