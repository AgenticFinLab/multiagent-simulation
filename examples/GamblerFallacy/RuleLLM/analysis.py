"""Analysis utilities for the GamblerFallacy RuleLLM variant."""
...
def main():
    """Run GamblerFallacy RuleLLM analysis using the standard output contract."""
    return _run_standard_analysis(
        "GamblerFallacy", "configs/GamblerFallacy/RuleLLM/simulation.yml"
    )
