...
STANDARD_OUTPUT_FILES = (
    ...
    "01_gamblerfallacy_dynamics.png",
    "02_gamblerfallacy_analysis.png",
    "03_summary.png",
)


def analyze_gamblerfallacy_standard(data: Dict[str, Any], config: Dict[str, Any], output_dir: str) -> Dict[str, Any]:
    """Run the project standard validation, summary, and fixed PNG outputs."""
    return _analyze_standard_scenario("GamblerFallacy", data, config, output_dir)


def main() -> Dict[str, Any]:
    """Run GamblerFallacy analysis using the standard output contract."""
    return _run_standard_analysis("GamblerFallacy", "configs/GamblerFallacy/Rule/simulation.yml")
...
__all__.extend([
    ...
    "_load_data",
    "STANDARD_OUTPUT_FILES",
    "analyze_gamblerfallacy_standard",
    "main",
])
