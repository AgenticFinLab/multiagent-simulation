...
Gambler's fallacy causes traders to expect reversals after streaks, misjudging independent events
...
Key Dynamics:
- StreakReversalTrader: Expects reversals after consecutive price moves, betting against streaks
- HotHandTrader: Believes winning streaks will continue, over-betting on recent winners
- IndependentAssessor: Correctly treats each price change as independent, no streak bias
...
Parameters from config (see configs/GamblerFallacy/Rule/players.yml):
"""
...
class StreakReversalTrader(GeneralPlayer):
    ...
    def _make_decision(self, price: float, fundamental: float, deviation: float) -> dict:
        ...
        streak_threshold = extras["streak_threshold"]
        reversal_bias = extras["reversal_bias"]
...
class HotHandTrader(GeneralPlayer):
    ...
    def _make_decision(self, price: float, fundamental: float, deviation: float) -> dict:
        ...
        cash = self.state.custom_state["cash"]
        position = self.state.custom_state["position"]
        hot_streak_threshold = extras["hot_streak_threshold"]
        continuation_bias = extras["continuation_bias"]
...
class IndependentAssessor(GeneralPlayer):
    ...
    def _make_decision(self, price: float, fundamental: float, deviation: float) -> dict:
        ...
        cash = self.state.custom_state["cash"]
        position = self.state.custom_state["position"]
        assessment_threshold = extras["assessment_threshold"]
...
class Arbitrageur(GeneralPlayer):
    ...
    def _make_decision(self, price: float, fundamental: float, deviation: float) -> dict:
        ...
        cash = self.state.custom_state["cash"]
        position = self.state.custom_state["position"]
        arbitrage_threshold = extras["arbitrage_threshold"]
