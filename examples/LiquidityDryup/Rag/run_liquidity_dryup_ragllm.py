#!/usr/bin/env python
"""LiquidityDryupRag Simulation Runner

Run RAG-augmented Rule+LLM liquidity dryup investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run LiquidityDryupRag Simulation")
    parser.add_argument(
