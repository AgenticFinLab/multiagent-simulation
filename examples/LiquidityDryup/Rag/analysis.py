...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for LiquidityDryup Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(description="Analyze LiquidityDryup Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/LiquidityDryup/Rag/simulation.yml",
    )
    ...
    summary = analyze_standard_scenario("LiquidityDryup", data, config, output_dir)
