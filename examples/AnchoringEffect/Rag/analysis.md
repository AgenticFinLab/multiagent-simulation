...
| `rag_retrieval_stats.json`     | `analyze_rag_knowledge_effect()` | Per-round per-agent retrieval metadata; chunk relevance scores; fallback rate             | RAG pipeline quality review                        |
