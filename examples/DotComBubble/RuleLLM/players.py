...
"""DotComBubble RuleLLM Simulation
...
from examples.DotComBubble.RuleLLM.prompts import format_user_prompt, get_prompt
from examples.DotComBubble.Rule.players import Market

logger = logging.getLogger("DotComBubble.RuleLLM")
...
class LLMNewEconomyEvangelist(LLMInvestor):
    """LLM-driven NewEconomyEvangelist."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "new_economy_evangelist"

class LLMIPOFlipper(LLMInvestor):
    """LLM-driven IPOFlipper."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "i_p_o_flipper"

class LLMMomentumFollower(LLMInvestor):
    """LLM-driven MomentumFollower."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "momentum_follower"

class LLMSkepticalValueInvestor(LLMInvestor):
    """LLM-driven SkepticalValueInvestor."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "skeptical_value_investor"

class LLMShortSeller(LLMInvestor):
    """LLM-driven ShortSeller."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "short_seller"
