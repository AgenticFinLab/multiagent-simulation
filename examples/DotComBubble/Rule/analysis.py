#!/usr/bin/env python
"""DotComBubble Rule analysis using the standard output contract."""
...
STANDARD_OUTPUT_FILES = (
    ...
    "01_dotcombubble_dynamics.png",
    "02_dotcombubble_analysis.png",
    "03_summary.png",
)
