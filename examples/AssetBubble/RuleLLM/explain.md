...
| `RuleLLMFundamentalInvestor` | `simulation-bases.md §4.4` | Shared RuleLLM path; prompt instructs infrequent value trades.                                                                              | `rulellm_fundamental_investor.config.extras.llm.sys_message -> RULELLM_VALUE_SYS` | Frequency gate and value-deviation sizing.                   |
