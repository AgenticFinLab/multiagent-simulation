"""FramingEffect Rag — RAG-augmented LLM simulation of framing effect trading dynamics."""
    ...
    def _build_prompt(self) -> str:
        ...
        if rag_store and rag_store.is_built():
            ...
            query = KnowledgeQuery(
                text=(
                    f"framing effect trading strategy "
...
class RagLLMGainFrameFollower(RagLLMInvestor):
    """RAG-augmented GainFrameFollower: overweights gains-framed information. Theory: simulation-bases.md §4.1."""
...
class RagLLMLossFrameReactor(RagLLMInvestor):
    """RAG-augmented LossFrameReactor: overweights loss-framed information. Theory: simulation-bases.md §4.2."""
...
class RagLLMFrameInvariantTrader(RagLLMInvestor):
    """RAG-augmented FrameInvariantTrader: evaluates by substance regardless of framing. Theory: simulation-bases.md §4.3."""
...
class RagLLMArbitrageFramer(RagLLMInvestor):
    """RAG-augmented ArbitrageFramer: exploits framing-induced mispricing. Theory: simulation-bases.md §4.4."""
...
class RagLLMNoiseTrader(RagLLMInvestor):
    """RAG-augmented NoiseTrader: random uninformed trader. Theory: simulation-bases.md §4.5."""

    _system_prompt_path = "examples.FramingEffect.Rag.prompts:RAGLLM_NOISE_TRADER_SYS"
