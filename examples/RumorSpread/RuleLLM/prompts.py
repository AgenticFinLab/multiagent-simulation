"""RumorSpreadRuleLLM Prompts - Hybrid Rule + LLM System and User Message Templates
...
Agents:
    - RuleLLM Gullible Spreader  → Allport & Postman leveling + credulity formula
    - RuleLLM Distorting Relayer → Sharpening + assimilation formula
    - RuleLLM Skeptical Evaluator → Critical evaluation + correction threshold
    - RuleLLM Fact Checker       → Active denial + credibility discount formula
    - RuleLLM Uninformed Bystander → Random engagement probability rule
"""

# =============================================================================
# RuleLLM Gullible Spreader
# Theory: Allport & Postman (1947) — Leveling
# Rule-based counterpart: RumorSpread.GullibleSpreader
# =============================================================================

RULELLM_GULLIBLE_SYS = """You are a GULLIBLE INFORMATION SPREADER in a social environment.
...
== YOUR TASK ==
Use the environment data to update your belief as defined above, then decide
whether to spread. You MAY adjust intensity by up to 20% based on qualitative
judgment, but the sign (spread/ignore) MUST follow the rule.
...
# =============================================================================
# RuleLLM Distorting Relayer
# Theory: Allport & Postman (1947) — Sharpening & Assimilation
# Rule-based counterpart: RumorSpread.DistortingRelayer
# =============================================================================

RULELLM_DISTORTING_SYS = """You are a DISTORTING RELAYER in a social information environment.
...
== YOUR TASK ==
Apply the sharpening and leveling formulas, then decide. You MAY adjust intensity
by up to 15%, but the action type MUST follow the rule.
...
# =============================================================================
# RuleLLM Skeptical Evaluator
# Theory: Bordia & Rosnow (1998) — Critical evaluation
# Rule-based counterpart: RumorSpread.SkepticalEvaluator
# =============================================================================

RULELLM_SKEPTICAL_SYS = """You are a SKEPTICAL EVALUATOR in a social information environment.
...
== YOUR TASK ==
Compute belief using the truth-anchored formula, then correct if confident.
...
# =============================================================================
# RuleLLM Fact Checker
# Theory: DiFonzo & Bordia (2007) — Active rumor denial
# Rule-based counterpart: RumorSpread.FactChecker
# =============================================================================

RULELLM_FACTCHECKER_SYS = """You are a PROFESSIONAL FACT CHECKER in a social information environment.
...
== YOUR TASK ==
Check if env_belief exceeds 0.3, then apply the fact-check formula with discount.
...
# =============================================================================
# RuleLLM Uninformed Bystander
# Theory: Shibutani (1966) — Minimal engagement
# Rule-based counterpart: RumorSpread.UninformedBystander
# =============================================================================

RULELLM_BYSTANDER_SYS = """You are an UNINFORMED BYSTANDER in a social information environment.
...
== YOUR TASK ==
Apply the random engagement heuristic, then decide. Keep your action simple.
