...
class SpeculativeAttacker(GeneralPlayer):
    ...
    async def decide(self) -> Dict:
        ...
        if deviation < -attack_threshold:
            ...
            qty = min(order_size, int(cash / price))
            if qty > 0:
        ...
        order = _build_order(
            ...
            cash,
            position,
            "Reserve-weakness speculative attack rule",
        )
        return {
            **order,
...
class SelfFulfillingTrader(GeneralPlayer):
    ...
    async def decide(self) -> Dict:
        ...
        if deviation < -contagion_threshold:
            ...
            qty = min(order_size // 2, int(cash / price))
            if qty > 0:
                action, quantity = "buy", qty
        ...
        order = _build_order(
            ...
            cash,
            position,
            "Expectation-coordination contagion rule",
        )
        return {
            **order,
            "outbound_messages": [{"payload": order, "content_type": "order"}],
...
class CentralBankDefender(GeneralPlayer):
    ...
    async def decide(self) -> Dict:
        ...
        order = _build_order(
            ...
            cash,
            position,
            "Reserve-financed peg defense rule",
        )
        return {
            **order,
            "outbound_messages": [{"payload": order, "content_type": "order"}],
...
class FundamentalHedger(GeneralPlayer):
    ...
    async def decide(self) -> Dict:
        ...
        order = _build_order(
            ...
            cash,
            position,
            "Fundamental-value hedge threshold rule",
        )
        return {
            **order,
            "outbound_messages": [{"payload": order, "content_type": "order"}],
...
class NoiseTrader(GeneralPlayer):
    ...
    async def decide(self) -> Dict:
        ...
        order = _build_order(
            ...
            cash,
            position,
            "Noise-trader random FX liquidity rule",
        )
        return {
            **order,
            "outbound_messages": [{"payload": order, "content_type": "order"}],
