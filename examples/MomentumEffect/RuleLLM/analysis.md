...
This analysis checks whether the RuleLLM variant produces a complete, analyzable Momentum Effect trajectory. It maps recorded price, fundamental, and volume series to the metric catalogue in `analysis-bases.md` and supports cross-variant comparison against the Rule baseline.
