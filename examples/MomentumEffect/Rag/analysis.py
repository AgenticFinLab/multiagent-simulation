...
02_momentumeffect_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for MomentumEffect Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(description="Analyze MomentumEffect Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/MomentumEffect/Rag/simulation.yml",
    )
    ...
    summary = analyze_standard_scenario("MomentumEffect", data, config, output_dir)
