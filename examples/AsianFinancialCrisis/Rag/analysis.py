#!/usr/bin/env python
"""AsianFinancialCrisis Rag Simulation Analysis

Rag-variant analysis for the AsianFinancialCrisis simulation.
...
Usage:
    python examples/AsianFinancialCrisis/Rag/analysis.py \\
...
def main() -> None:
    """Run full AsianFinancialCrisis Rag analysis pipeline.
    ...
    parser = argparse.ArgumentParser(
        description="Analyze AsianFinancialCrisis Rag simulation results"
    )
    parser.add_argument(
        "-c",
        "--config",
