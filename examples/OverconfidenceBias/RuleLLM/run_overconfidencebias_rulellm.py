...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run OverconfidenceBias RuleLLM Simulation"
    )
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/OverconfidenceBias/RuleLLM/simulation.yml",
    )
    ...
    print("\n" + "=" * 70)
    print("OverconfidenceBias Simulation - RuleLLM Agents")
    print("=" * 70)
