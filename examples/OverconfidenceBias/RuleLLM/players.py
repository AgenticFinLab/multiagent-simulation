...
"""OverconfidenceBias RuleLLM Simulation
...
from examples.OverconfidenceBias.RuleLLM.prompts import format_user_prompt, get_prompt
from examples.OverconfidenceBias.Rule.players import Market
...
class LLMOverconfidentTrader(LLMInvestor):
    ...
    def _initialize_investor_state(self) -> None:
        ...
        self.agent_type = "overconfident_trader"
...
class LLMSelfAttributor(LLMInvestor):
    ...
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "self_attributor"
...
class LLMCalibratedTrader(LLMInvestor):
    ...
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "calibrated_trader"
...
class LLMContrarianInvestor(LLMInvestor):
    ...
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "contrarian_investor"
