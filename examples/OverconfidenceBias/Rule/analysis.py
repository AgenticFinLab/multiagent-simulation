#!/usr/bin/env python
"""OverconfidenceBias Rule analysis using the standard output contract."""
...
STANDARD_OUTPUT_FILES = (
    ...
    "01_overconfidencebias_dynamics.png",
    "02_overconfidencebias_analysis.png",
    "03_summary.png",
)
...
def analyze_overconfidencebias(data: Dict[str, Any], config: Dict[str, Any], output_dir: str) -> Dict[str, Any]:
    """Run metrics, validation, plots, and `summary.json` output."""
    return analyze_standard_scenario(SCENARIO, data, config, output_dir)


def main() -> Dict[str, Any]:
    """Run OverconfidenceBias analysis."""
