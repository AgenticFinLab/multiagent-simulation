...
- Output: `01_archegoscollapse_dynamics.png`, `02_archegoscollapse_analysis.png`, and `03_summary.png` — standard cascade and participation views
...
**Variant-Specific Interpretation:**
Target: each agent ≥80% adherence. PrimeBrokerFirstMover should show nearly perfect adherence (simple threshold). ConcentratedFund may show lower adherence (persona denial psychology may occasionally override rule). InformationTrader adherence harder to measure (probabilistic detection).
...
| `00_investor_bids.png`             | `_create_visualizations()`    | Market price and RuleLLM investor bid curves            | Rule-following order-path visualization       |
