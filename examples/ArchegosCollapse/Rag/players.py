"""ArchegosCollapse Rag — RAG-augmented Archegos Collapse Simulation
...
class RagLLMInvestor(GeneralPlayer):
    """Base class for RAG-augmented investors in the ArchegosCollapse scenario."""
    ...
    def _build_prompt(self, market_data: Dict[str, Any]) -> str:
        ...
        if rag_store and rag_store.is_built():
            ...
            query = KnowledgeQuery(
                text=(
                    f"forced liquidation cascade strategy when: "
