...
"""ArchegosCollapse Rag Simulation
...
from examples.ArchegosCollapse.Rag.prompts import format_user_prompt, get_prompt
...
class LLMConcentratedFund(LLMInvestor):
    """LLM-driven ConcentratedFund."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "concentrated_fund"

class LLMPrimeBroker1(LLMInvestor):
    """LLM-driven PrimeBroker1."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "prime_broker1"

class LLMPrimeBroker2(LLMInvestor):
    """LLM-driven PrimeBroker2."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "prime_broker2"

class LLMBlockTradeBuyer(LLMInvestor):
    """LLM-driven BlockTradeBuyer."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "block_trade_buyer"

class LLMInformationTrader(LLMInvestor):
    """LLM-driven InformationTrader."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "information_trader"


__all__ = ["Market", "LLMInvestor", "LLMConcentratedFund", "LLMPrimeBroker1", "LLMPrimeBroker2", "LLMBlockTradeBuyer", "LLMInformationTrader"]
