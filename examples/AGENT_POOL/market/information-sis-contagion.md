...
| Scenario Portability | Used by information-domain scenarios where the collective observable is a scalar belief index over [0, 1] against a truth reference. Reference host: **RumorSpread**. Reusable for FakeNews, MisinformationCascade, Debunking, and any scenario requiring rumor-vs-fact-checking contest dynamics. |
