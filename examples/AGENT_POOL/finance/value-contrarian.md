...
| Created     | 2026-06-11                                                                                                                                                                                                                             |
| Version     | 1.1.0                                                                                                                                                                                                                                  |
| Change log  | 1.0.0 - Created for AsianFinancialCrisis; 1.0.3 - Transformer structural additions; 1.1.0 - Full §3 conformance authoring pass (all 11 sections, 6 H4 sub-blocks, 5 I/O Contract blocks, 3 IF-THEN sanity bounds, complete references) |
| Status      | conformant                                                                                                                                                                                                                             |
