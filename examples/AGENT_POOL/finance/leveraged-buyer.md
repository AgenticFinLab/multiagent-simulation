...
- 0.1.1 (2026-07-11): AGENT_POOL icon `finance-leveraged-buyer.png` generated via agent-icon-generation-skill (lever motif, 杠杆型投资者). Closes Step 2 icon-resolution gate for the AssetBubble polish run.
