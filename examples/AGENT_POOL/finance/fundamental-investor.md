...
- 0.1.1 (2026-07-11): AGENT_POOL icon `finance-fundamental-investor.png` generated via agent-icon-generation-skill (magnifier + diamond motif, 基本面型投资者). Closes Step 2 icon-resolution gate for the AssetBubble polish run.
