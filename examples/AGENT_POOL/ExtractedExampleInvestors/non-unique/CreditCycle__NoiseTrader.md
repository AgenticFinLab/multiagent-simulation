...
| llm | LLM: `{'sys_message': 'examples.CreditCycle.LLM.prompts:LLM_NOISE_TRADER_SYS', 'user_message': 'examples.CreditCycle.LLM.prompts:LLM_USER_TEMPLATE', 'lm_type': 'api', 'lm_name': 'ark/doubao-seed-2-0-mini-260428', 'generation_config': {'temperature': 0.9, 'max_tokens': 512}}`<br>RuleLLM: `{'sys_message': 'examples.CreditCycle.RuleLLM.prompts:RULELLM_NOISE_TRADER_SYS', 'user_message': 'examples.CreditCycle.RuleLLM.prompts:RULELLM_USER_TEMPLATE', 'lm_type': 'api', 'lm_name': 'ark/doubao-seed-2-0-mini-260428', 'generation_config': {'temperature': 0.9, 'max_tokens': 512}}`<br>Rag: `{'sys_message': 'examples.CreditCycle.Rag.prompts:RAG_NOISE_TRADER_SYS', 'user_message': 'examples.CreditCycle.Rag.prompts:RAG_USER_TEMPLATE', 'lm_type': 'api', 'lm_name': 'ark/doubao-seed-2-0-mini-260428', 'generation_config': {'temperature': 0.9, 'max_tokens': 600}}` | LLM, Rag, RuleLLM |
...
| --- | --- | --- | --- | --- | --- |
| Rule | noisetrader | NoiseTrader | `NoiseTrader` | 1 | `examples/CreditCycle/Rule/players.py` |
| LLM | noisetrader | NoiseTrader | `LLMNoiseTrader` | 1 | `examples/CreditCycle/LLM/players.py` |
| RuleLLM | noisetrader | NoiseTrader | `RuleLLMNoiseTrader` | 1 | `examples/CreditCycle/RuleLLM/players.py` |
| Rag | noisetrader | NoiseTrader | `RagLLMNoiseTrader` | 1 | `examples/CreditCycle/Rag/players.py` |
