# FlashCrashLLM - LLM-Powered Flash Crash Simulation
...
| File                                            | Purpose                          |
|-------------------------------------------------|----------------------------------|
| `examples/FlashCrashLLM/players.py`             | Market + 5 LLM investor classes  |
| `examples/FlashCrashLLM/prompts.py`             | System and user prompt templates |
| `examples/FlashCrashLLM/run_flash_crash_llm.py` | Entry point                      |
| `configs/FlashCrashLLM/simulation.yml`          | Main config                      |
| `configs/FlashCrashLLM/players.yml`             | Player definitions + LLM config  |
| `configs/FlashCrashLLM/topology.yml`            | Star topology                    |
...
| Theory                   | Application in FlashCrashLLM     | Reference               |
|--------------------------|----------------------------------|-------------------------|
