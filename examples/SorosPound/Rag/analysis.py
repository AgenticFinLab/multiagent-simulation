#!/usr/bin/env python
"""SorosPound Rag Simulation Analysis.
...
02_sorospound_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for SorosPound Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(description="Analyze SorosPound Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
    ...
    summary = analyze_standard_scenario("SorosPound", data, config, output_dir)
