...
Usage:
    python examples/VolatilityClusteringLLM/run_volatility_llm.py -c configs/VolatilityClusteringLLM/simulation.yml
"""
...
async def run_simulation(config_path: str):
    ...
    logger.info(
        "  python examples/VolatilityClusteringLLM/analysis.py -c %s", config_path
    )
    logger.info("=" * 70)
