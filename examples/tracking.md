# Examples Scenario Tracking

Coordination table for `examples/` scenarios. Record modifications here to prevent conflicts and maintain audit trail.
...
| 7  | CarryTradeUnwind       | 🟢     | Qiqi        | Jul 8 2026  | LLM, Rule, RuleLLM, Rag                  |
...
| 25 | HindsightBias          | 🟡      |              |             |                    |
| 26 | LiquidityDryup         | 🟢      | Wenyou      | 2026-07-23 | Rule              |
| 27 | LossAversion           | 🟢      | Wenyou      | Jul 16 2026 | LLM, Rule, RuleLLM |
| 28 | LTCMCollapse           | 🟢      | Wenyou      | Jul 16 2026 | LLM, Rule, RuleLLM |
| 29 | LUNACollapse           | 🟢      | Wenyou      | Jul 20 2026 | LLM, Rule, RuleLLM |
| 30 | MarketCrash            | 🟢      | Wenyou      | 2026-07-21  | LLM, Rule, RuleLLM |
| 31 | MentalAccounting       | ⬜      | —           | —           | —                 |
...
> **Date** — Date of the most recent modification (YYYY-MM-DD)  
> **Executed Variants** — Which simulation variants have been successfully run (e.g. `Rule`, `LLM`, `Rag`, `RuleLLM`)
