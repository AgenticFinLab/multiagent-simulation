...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run GameStopShortSqueeze Rag Simulation"
    )
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/GameStopShortSqueeze/Rag/simulation.yml",
    )
    ...
    print("\n" + "=" * 70)
    print("GameStopShortSqueeze Simulation - Rag Agents")
    print("=" * 70)
