...
from examples.GameStopShortSqueeze.Rag.prompts import format_user_prompt, get_prompt
...
class LLMRetailCoordinated(LLMInvestor):
    """LLM-driven RetailCoordinated."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "retail_coordinated"

class LLMShortSellerHF(LLMInvestor):
    """LLM-driven ShortSellerHF."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "short_seller_h_f"

class LLMMarketMakerGamma(LLMInvestor):
    """LLM-driven MarketMakerGamma."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "market_maker_gamma"

class LLMInstitutionalValue(LLMInvestor):
    """LLM-driven InstitutionalValue."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "institutional_value"

class LLMMomentumRetail(LLMInvestor):
    """LLM-driven MomentumRetail."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "momentum_retail"


__all__ = ["Market", "LLMInvestor", "LLMRetailCoordinated", "LLMShortSellerHF", "LLMMarketMakerGamma", "LLMInstitutionalValue", "LLMMomentumRetail"]
