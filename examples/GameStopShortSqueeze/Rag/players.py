"""GameStopShortSqueeze Rag Simulation
...
logger = logging.getLogger("GameStopShortSqueeze.Rag")
...
class RagLLMInvestor(GeneralPlayer):
    ...
    async def decide(self):
        ...
        if self._rag_retriever is not None:
            try:
                query = f"GameStop short squeeze price={price:.2f} deviation={deviation:+.2%}"
...
class RagLLMRetailCoordinated(RagLLMInvestor):
    """RagLLM-driven retail coordinated buyer."""
...
class RagLLMShortSellerHF(RagLLMInvestor):
    """RagLLM-driven short seller hedge fund."""
...
class RagLLMMarketMakerGamma(RagLLMInvestor):
    """RagLLM-driven gamma-hedging market maker."""
...
class RagLLMInstitutionalValue(RagLLMInvestor):
    """RagLLM-driven institutional value investor."""
...
class RagLLMMomentumRetail(RagLLMInvestor):
    """RagLLM-driven FOMO momentum retail trader."""
