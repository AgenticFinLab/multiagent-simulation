#!/usr/bin/env python
"""GameStopShortSqueeze Rag analysis with standard outputs and RAG stats."""
...
def analyze_rag_knowledge_effect(
    ...
    """Summarize RAG retrieval coverage for short-squeeze runs."""
...
def main() -> None:
    """Run GameStopShortSqueeze Rag analysis and write `rag_stats.json`."""
    parser = argparse.ArgumentParser(
        description="Analyze GameStopShortSqueeze Rag results"
    )
