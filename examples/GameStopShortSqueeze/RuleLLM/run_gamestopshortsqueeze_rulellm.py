...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run GameStopShortSqueeze RuleLLM Simulation"
    )
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/GameStopShortSqueeze/RuleLLM/simulation.yml",
    )
    ...
    print("\n" + "=" * 70)
    print("GameStopShortSqueeze Simulation - RuleLLM Agents")
    print("=" * 70)
