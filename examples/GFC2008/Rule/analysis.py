#!/usr/bin/env python
"""GFC2008 Simulation Analysis

Analyze the GFC2008 simulation results.

Usage:
    python examples/GFC2008/Rule/analysis.py \
...
def create_visualizations(data: dict, output_path: str) -> None:
    ...
    fig.suptitle("GFC2008 Simulation Analysis", fontsize=14, fontweight="bold")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_path, "gfc2008_analysis.png"), dpi=150)
    plt.close()


def main():
    parser = argparse.ArgumentParser(description="Analyze GFC2008 simulation results")
    parser.add_argument("-c", "--config", type=str, default="configs/GFC2008/Rule/simulation.yml")
