#!/usr/bin/env python
"""GFC2008 Rule analysis using the standard output contract."""
...
STANDARD_OUTPUT_FILES = (
    ...
    "01_gfc2008_dynamics.png",
    "02_gfc2008_analysis.png",
    "03_summary.png",
)
