...
<!--
  ...
  handoff in-line; the resulting §11 exceptions and audit trail are
  recorded in the sibling `simulation-build-log.md` per
  define-simulation-scenario-skill.md §6.
-->
