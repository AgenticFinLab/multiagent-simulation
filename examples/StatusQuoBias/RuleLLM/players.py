"""StatusQuoBias RuleLLM Simulation

Hybrid Rule+LLM variant of StatusQuoBias.
...
class RuleLLMInvestor(GeneralPlayer):
    """Base class for hybrid Rule+LLM StatusQuoBias investors."""
