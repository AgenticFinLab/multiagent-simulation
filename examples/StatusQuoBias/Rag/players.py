"""StatusQuoBias Rag Simulation

RAG-augmented hybrid Rule+LLM variant of StatusQuoBias.
...
class RagLLMInvestor(GeneralPlayer):
    """Base class for RAG-augmented StatusQuoBias investors."""
    ...
    def _build_prompt(self) -> str:
        ...
        if rag_store and rag_store.is_built():
            ...
            query = KnowledgeQuery(
                text=(
                    f"status quo bias inertia: deviation={deviation * 100:+.2f}%, "
