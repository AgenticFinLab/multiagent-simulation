#!/usr/bin/env python
"""BlackMonday1987 Simulation Analysis

Analyze the BlackMonday1987 simulation results.
...
def create_visualizations(data: dict, output_path: str) -> None:
    ...
    fig.suptitle("BlackMonday1987 Simulation Analysis", fontsize=14, fontweight="bold")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_path, "blackmonday1987_analysis.png"), dpi=150)
    plt.close()


def main():
    parser = argparse.ArgumentParser(description="Analyze BlackMonday1987 simulation results")
    parser.add_argument("-c", "--config", type=str, default="configs/BlackMonday1987/Rule/simulation.yml")
