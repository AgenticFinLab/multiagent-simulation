...
- Output: `01_blackmonday1987_dynamics.png` for price/deviation and `02_blackmonday1987_analysis.png` for feedback diagnostics
...
| **100 rounds** | Core crash lifecycle visible; partial recovery likely in short calibration runs |
