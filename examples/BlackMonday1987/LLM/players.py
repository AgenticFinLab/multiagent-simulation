...
"""BlackMonday1987 LLM Simulation
...
from examples.BlackMonday1987.LLM.prompts import format_user_prompt, get_prompt
from examples.BlackMonday1987.Rule.players import Market

logger = logging.getLogger("BlackMonday1987.LLM")
