...
|--------------------|--------------------------|------------------------------------------|-------------------|-------------------------------|----------------------------------------------------------------------------|----------------------------------------------------|
| portfolio-insurer  | mutual fund / pension    | Liquidity / Funding (§4.1)               | Destabilising     | price, fundamental, deviation | Exists to reduce equity exposure mechanically as the index falls.          | masim/agents/defines/finance/portfolio-insurer.md   |
| index-arbitrageur  | proprietary trading desk | Microstructure (§4.2)                    | Context-dependent | price, fundamental, deviation | Exists to transmit futures-cash dislocations into spot index order flow.   | masim/agents/defines/finance/index-arbitrageur.md   |
| program-trader     | quant fund / CTA         | Behavioral Finance (§4.3)                | Destabilising     | price, deviation, round       | Exists to amplify downward moves through threshold-based feedback selling. | masim/agents/defines/finance/program-trader.md      |
| value-investor     | mutual fund / pension    | Fundamental / Value (§4.4)               | Stabilising       | price, fundamental, deviation | Exists to supply contrarian demand after a sufficiently deep discount.     | masim/agents/defines/finance/fundamental-analyst.md |
| noise-trader       | retail investor          | Noise / Liquidity-providing noise (§4.5) | Context-dependent | price, round, rng_state       | Exists to provide stochastic background order flow.                        | masim/agents/defines/finance/noise-trader.md        |
