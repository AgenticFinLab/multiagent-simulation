#!/usr/bin/env python
"""EuropeanDebtCrisis Rule analysis using the standard output contract."""
...
def analyze_europeandebtcrisis(data: Dict[str, Any], config: Dict[str, Any], output_dir: str) -> Dict[str, Any]:
    """Run metrics, validation, plots, and `summary.json` output."""
    return analyze_standard_scenario(SCENARIO, data, config, output_dir)


def main() -> Dict[str, Any]:
    """Run EuropeanDebtCrisis analysis."""
