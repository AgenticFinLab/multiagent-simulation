...
Hybrid Rule+LLM variant of SVBBankRun.
...
from .prompts import (
    ...
    RULELLM_BANK_MANAGER_SYS,
    RULELLM_REGULATOR_SYS,
    RULELLM_BOND_TRADER_SYS,
)
...
class RuleLLMInvestor(GeneralPlayer):
    """Base class for hybrid Rule+LLM SVBBankRun investors."""
