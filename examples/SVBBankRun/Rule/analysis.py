#!/usr/bin/env python
"""SVBBankRun Rule analysis using the standard output contract."""
...
STANDARD_OUTPUT_FILES = (
    ...
    "01_svbbankrun_dynamics.png",
    "02_svbbankrun_analysis.png",
    "03_summary.png",
)
