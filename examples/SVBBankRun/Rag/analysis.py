#!/usr/bin/env python
"""SVBBankRun Rag analysis with RAG retrieval-quality audit."""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for SVBBankRun Rag runs."""
...
def main() -> Dict[str, Any]:
    """Run standard analysis plus RAG retrieval audit."""
    parser = argparse.ArgumentParser(description="Analyze SVBBankRun Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/SVBBankRun/Rag/simulation.yml",
    )
    ...
    summary = analyze_standard_scenario("SVBBankRun", data, config, output_dir)
