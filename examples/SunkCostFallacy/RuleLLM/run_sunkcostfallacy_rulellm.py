...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run SunkCostFallacy RuleLLM Simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/SunkCostFallacy/RuleLLM/simulation.yml",
    )
    ...
    print("\n" + "=" * 70)
    print("SunkCostFallacy Simulation - RuleLLM Agents")
    print("=" * 70)
