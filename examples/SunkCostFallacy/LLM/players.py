"""SunkCostFallacy LLM Simulation

LLM-driven variant of SunkCostFallacy.
...
from .prompts import (
    ...
    LLM_RATIONAL_CUTTER_SYS,
    LLM_OPPORTUNITY_COST_TRADER_SYS,
...
class LLMInvestor(GeneralPlayer):
    """Base class for LLM-driven SunkCostFallacy investors."""
