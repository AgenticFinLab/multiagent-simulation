#!/usr/bin/env python
"""Herding Information Cascade RuleLLM Simulation Analysis.
...
def main():
    ...
    return run_standard_analysis("HerdingInformation", "configs/HerdingInformation/RuleLLM/simulation.yml")
