#!/usr/bin/env python
"""Herding Information Cascade Rag Simulation Analysis.
...
02_herdinginformation_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for HerdingInformation Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(
        description="Analyze HerdingInformation Rag simulation"
    )
    parser.add_argument(
        "-c",
        "--config",
    ...
    summary = analyze_standard_scenario(
        "HerdingInformation", data, config, output_dir
    )
