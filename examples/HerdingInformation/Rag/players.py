"""HerdingInformation Rag — RAG-augmented LLM simulation of information cascade and herding dynamics."""
    ...
    async def decide(self) -> dict:
        ...
        if rag_store and rag_store.is_built():
            query = KnowledgeQuery(
                text=(
                    f"information cascade herding trading strategy "
        ...
        llm_client: Optional[LangChainAPIInference] = self.state.custom_state.get(
            "llm_client"
        )
...
class RagLLMCascadeFollower(RagLLMInvestor):
    """RagLLM-driven information cascade follower. Theory: simulation-bases.md §4.1."""
...
class RagLLMReputationHerder(RagLLMInvestor):
    """RagLLM-driven reputation-based herder. Theory: simulation-bases.md §4.2."""
...
class RagLLMIndependentThinker(RagLLMInvestor):
    """RagLLM-driven rational independent thinker. Theory: simulation-bases.md §4.3."""
...
class RagLLMContrarian(RagLLMInvestor):
    """RagLLM-driven contrarian investor. Theory: simulation-bases.md §4.4."""
