...
This analysis checks whether the Rule variant produces a complete, analyzable Tulip Mania trajectory. It maps recorded price, fundamental, and volume series to the metric catalogue in `analysis-bases.md` and supports cross-variant comparison against the Rule baseline.
