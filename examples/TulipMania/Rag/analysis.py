...
02_tulipmania_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for TulipMania Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(description="Analyze TulipMania Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/TulipMania/Rag/simulation.yml",
    )
    ...
    summary = analyze_standard_scenario("TulipMania", data, config, output_dir)
