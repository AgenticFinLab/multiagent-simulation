...
from examples.TulipMania.LLM.prompts import format_user_prompt, get_prompt
from examples.TulipMania.Rule.players import Market

logger = logging.getLogger("TulipMania.LLM")


class TrendChaser(GeneralPlayer):
    """LLM-driven TrendChaser. Buys assets purely because prices are rising, regardless of intrinsic value"""
...
class SocialProofFollower(GeneralPlayer):
    """LLM-driven SocialProofFollower. Follows crowd into speculative positions because everyone else is doing it"""
    def __init__(self, config=None):
        super().__init__(config)
        self.llm_client = None
        self.agent_type = ""
...
class IntrinsicValueTrader(GeneralPlayer):
    """LLM-driven IntrinsicValueTrader. Values assets by intrinsic utility, sells when price far exceeds use value"""
    def __init__(self, config=None):
        super().__init__(config)
        self.llm_client = None
        self.agent_type = ""
...
class EarlyExitTrader(GeneralPlayer):
    """LLM-driven EarlyExitTrader. Recognizes speculative excess early and exits before the crash"""
    def __init__(self, config=None):
        super().__init__(config)
        self.llm_client = None
        self.agent_type = ""
...
__all__ = ["Market", "TrendChaser, SocialProofFollower, IntrinsicValueTrader, EarlyExitTrader, NoiseTrader"]
