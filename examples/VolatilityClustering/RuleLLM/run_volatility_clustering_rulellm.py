#!/usr/bin/env python
"""VolatilityClusteringRuleLLM Simulation Runner

Run hybrid Rule+LLM volatility clustering investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run VolatilityClusteringRuleLLM Simulation"
    )
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/VolatilityClustering/RuleLLM/simulation.yml",
    )
    ...
    print("\n" + "=" * 60)
    print("VolatilityClusteringRuleLLM Simulation")
    print("=" * 60)
    print("Phenomenon: VolatilityClustering with Rule-Guided LLM Decision-Making")
