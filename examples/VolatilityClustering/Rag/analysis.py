#!/usr/bin/env python
"""Volatility Clustering Rag Simulation Analysis.
...
02_volatilityclustering_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for VolatilityClustering Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(
        description="Analyze VolatilityClustering Rag simulation"
    )
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/VolatilityClustering/Rag/simulation.yml",
    )
    ...
    summary = analyze_standard_scenario("VolatilityClustering", data, config, output_dir)
