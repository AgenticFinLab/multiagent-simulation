...
02_herdeffect_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for HerdEffect Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(description="Analyze HerdEffect Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/HerdEffect/Rag/simulation.yml",
    )
    ...
    summary = analyze_standard_scenario("HerdEffect", data, config, output_dir)
