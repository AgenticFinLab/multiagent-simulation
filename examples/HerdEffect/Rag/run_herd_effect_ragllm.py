#!/usr/bin/env python
"""HerdEffectRag Simulation Runner

Run RAG-augmented Rule+LLM herd effect investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run HerdEffectRag Simulation")
    parser.add_argument(
