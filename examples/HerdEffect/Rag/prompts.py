"""HerdEffect Rag Prompts - Retrieval-Augmented Hybrid Rule + LLM Templates
...
Agents:
    ...
    - Rag Risk Averse          → Variance-adjusted position sizing (Markowitz)
    - Rag Aggressive           → Acceleration-enhanced momentum
