#!/usr/bin/env python
"""ShortSqueezeRuleLLM Simulation Runner

Run hybrid Rule+LLM short squeeze investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run ShortSqueezeRuleLLM Simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/ShortSqueeze/RuleLLM/simulation.yml",
    )
    ...
    print("\n" + "=" * 60)
    print("ShortSqueezeRuleLLM Simulation")
    print("=" * 60)
    print("Phenomenon: ShortSqueeze with Rule-Guided LLM Decision-Making")
