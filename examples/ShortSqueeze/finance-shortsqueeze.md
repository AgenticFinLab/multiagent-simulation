...
| Name        | ShortSqueeze                                                                                                                    |
| Domain      | finance                                                                                                                         |
| Phenomenon  | Forced short-covering by loss-exceeding sellers creates a self-reinforcing price spike amplified by momentum and retail demand. |
...
|----------------------|-----------------------|-----------:|----------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|------------------------------------------|
| Short seller         | `ShortSeller`         |          3 | Forced buyer         | Holds `short_initial_position = -50`; if `(price − short_entry_price)/short_entry_price > cover_threshold = 0.20`, buys `                                                                                       | position                 | × 0.5` and sets `is_short_cover = True`. |
