#!/usr/bin/env python
"""ShortSqueezeRag Simulation Runner

Run RAG-augmented Rule+LLM short squeeze investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run ShortSqueezeRag Simulation")
    parser.add_argument(
        "-c", "--config", type=str, default="configs/ShortSqueeze/Rag/simulation.yml"
    )
    ...
    print("\n" + "=" * 60)
    print("ShortSqueezeRag Simulation")
    print("=" * 60)
    print("Phenomenon: Short Squeeze with RAG-Augmented LLM Decision-Making")
