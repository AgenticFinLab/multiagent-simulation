...
RAGLLM_SHORT_SELLER_SYS = """You are a SHORT SELLER in the financial market.
...
== DECISION RULES (from ShortSeller) ==
...
RAGLLM_MOMENTUM_BUYER_SYS = """You are a MOMENTUM BUYER in the financial market.
...
== DECISION RULES (from MomentumBuyer) ==
...
RAGLLM_RETAIL_TRADER_SYS = """You are a RETAIL TRADER in the financial market.
...
== DECISION RULES (from RetailTrader) ==
...
RAGLLM_INSTITUTIONAL_HOLDER_SYS = """You are a INSTITUTIONAL HOLDER in the financial market.
...
== DECISION RULES (from InstitutionalHolder) ==
