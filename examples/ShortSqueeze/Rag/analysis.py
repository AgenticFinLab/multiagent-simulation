...
02_shortsqueeze_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for ShortSqueeze Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(description="Analyze ShortSqueeze Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/ShortSqueeze/Rag/simulation.yml",
    )
    ...
    summary = analyze_standard_scenario("ShortSqueeze", data, config, output_dir)
