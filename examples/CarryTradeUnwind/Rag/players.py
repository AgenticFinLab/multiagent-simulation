"""CarryTradeUnwind Rag — RAG-augmented LLM simulation of carry trade unwind dynamics."""
...
class RagLLMInvestor(GeneralPlayer):
    """Base RAG-augmented LLM investor for CarryTradeUnwind."""
    ...
    async def _initialize_agent(self) -> None:
        ...
        self.state.custom_state["history_buffer"] = HistoryBuffer(
            folder=f"CarryTradeUnwind/Rag/{self.__class__.__name__}", entry_limit=200
        )
    ...
    def _build_prompt(self, market_data: Dict[str, Any]) -> str:
        ...
        if rag_store and rag_store.is_built():
            ...
            query = KnowledgeQuery(
                text=(
                    f"carry trade strategy: rate={price:.4f}, "
