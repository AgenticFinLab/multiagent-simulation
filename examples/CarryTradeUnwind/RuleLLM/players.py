...
from examples.CarryTradeUnwind.RuleLLM.prompts import format_user_prompt, get_prompt

logger = logging.getLogger("CarryTradeUnwind.RuleLLM")

from examples.CarryTradeUnwind.Rule.players import Market



class CarryTrader(GeneralPlayer):
    """
    LLM-driven CarryTrader.
...
class FundingCurrencyBuyer(GeneralPlayer):
    """
    LLM-driven FundingCurrencyBuyer.
