...
|------------------------|------------------------------------------|---------------------------------------|-------------------|-------------------------------|-----------------------------------------------------------------------------------------------------|-------------------------------------------------------|
| carry-trader           | hedge fund / leveraged currency investor | Carry Trade / Risk-On-Risk-Off (§4.1) | Destabilising     | price, deviation, round       | Exists to build carry exposure in calm conditions and unwind when the funding currency appreciates. | masim/agents/defines/finance/carry-trader.md           |
| leveraged-carry-fund   | macro hedge fund / leveraged fund        | Liquidity / Funding (§4.2)            | Destabilising     | price, deviation, position    | Exists to transmit margin and stop-loss pressure into forced FX selling.                            | masim/agents/defines/finance/leveraged-carry-fund.md   |
| funding-currency-buyer | reserve manager / safe-haven buyer       | Safe-haven currency demand (§4.3)     | Stabilising       | price, deviation, round       | Exists to provide partial safe-haven demand when downside carry stress becomes severe.              | masim/agents/defines/finance/funding-currency-buyer.md |
| hedged-carry-trader    | volatility-managed macro fund            | Volatility-managed carry (§4.4)       | Context-dependent | price, deviation, rolling_vol | Exists to reduce carry exposure when FX volatility rises above its risk budget.                     | masim/agents/defines/finance/hedged-carry-trader.md    |
| noise-trader           | uninformed FX liquidity participant      | Noise / Market Microstructure (§4.5)  | Context-dependent | price, round, rng_state       | Exists to supply bounded background FX order flow.                                                  | masim/agents/defines/finance/noise-trader.md           |
