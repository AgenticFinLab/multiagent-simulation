"""EquityPremium Rag analysis with retrieval-quality audit."""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for EquityPremium Rag runs."""
...
def main() -> Dict[str, Any]:
    """Run EquityPremium Rag analysis."""
    parser = argparse.ArgumentParser(description="Analyze EquityPremium Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/EquityPremium/Rag/simulation.yml",
    )
