"""EquityPremiumRag — RAG-augmented Rule+LLM Equity Premium Simulation
...
This extends the three-variant comparison:
    ...
    EquityPremiumRuleLLM — LLM with rules in prompt (no external knowledge)
    EquityPremiumRag     — LLM with rules in prompt + RAG knowledge retrieval
...
1. **Via Streamlit Web UI (Recommended):**
   ...
   ```
   Then select "EquityPremiumRag" from the scenario dropdown.

2. **Command Line:**

   ```bash
   python examples/EquityPremium/Rag/run_flash_crash_ragllm.py \
...
logger = logging.getLogger("EquityPremiumRag")
...
# =============================================================================
# Market — Rule-Based Coordinator (identical to EquityPremiumRuleLLM.Market)
# =============================================================================
...
class RagLLMInvestor(GeneralPlayer):
    """
    Base class for RAG-augmented Rule+LLM equity premium investors.
