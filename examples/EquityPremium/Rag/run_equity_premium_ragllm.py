#!/usr/bin/env python
"""EquityPremiumRag Simulation Runner

Run RAG-augmented Rule+LLM equity premium investor simulation.
...
Usage:
    python examples/EquityPremium/Rag/run_equity_premium_ragllm.py -c configs/EquityPremium/Rag/simulation.yml
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run EquityPremiumRag Simulation")
    parser.add_argument(
        "-c", "--config", type=str, default="configs/EquityPremium/Rag/simulation.yml"
    )
    ...
    print("\n" + "=" * 60)
    print("EquityPremiumRag Simulation")
    print("=" * 60)
    print("Phenomenon: Equity Premium with RAG-Augmented LLM Decision-Making")
