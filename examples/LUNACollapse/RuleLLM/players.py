...
"""LUNACollapse RuleLLM Simulation
...
from examples.LUNACollapse.RuleLLM.prompts import format_user_prompt, get_prompt
...
class LLMStablecoinHolder(LLMInvestor):
    """LLM-driven StablecoinHolder."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "stablecoin_holder"
...
class LLMArbitrageur(LLMInvestor):
    ...
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "arbitrageur"

class LLMDeFiLender(LLMInvestor):
    """LLM-driven DeFiLender."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "de_fi_lender"

class LLMAnchorDepositor(LLMInvestor):
    """LLM-driven AnchorDepositor."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "anchor_depositor"

class LLMValueBuyer(LLMInvestor):
    """LLM-driven ValueBuyer."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "value_buyer"
