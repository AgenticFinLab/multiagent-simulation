#!/usr/bin/env python
"""MarketCrashRuleLLM Simulation Runner

Run hybrid Rule+LLM market crash investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run MarketCrashRuleLLM Simulation")
    parser.add_argument(
        "-c", "--config", type=str, default="configs/MarketCrash/RuleLLM/simulation.yml"
    )
    ...
    print("\n" + "=" * 60)
    print("MarketCrashRuleLLM Simulation")
    print("=" * 60)
    print("Phenomenon: MarketCrash with Rule-Guided LLM Decision-Making")
