#!/usr/bin/env python
"""Market Crash Rag Simulation Analysis.
...
02_marketcrash_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for MarketCrash Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(description="Analyze MarketCrash Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
        default="configs/MarketCrash/Rag/simulation.yml",
    )
    ...
    summary = analyze_standard_scenario("MarketCrash", data, config, output_dir)
