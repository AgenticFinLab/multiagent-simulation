#!/usr/bin/env python
"""MarketCrashRag Simulation Runner

Run RAG-augmented Rule+LLM market crash investor simulation.
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run MarketCrashRag Simulation")
    parser.add_argument(
        "-c", "--config", type=str, default="configs/MarketCrash/Rag/simulation.yml"
    )
    ...
    print("\n" + "=" * 60)
    print("MarketCrashRag Simulation")
    print("=" * 60)
    print("Phenomenon: Market Crash with RAG-Augmented LLM Decision-Making")
