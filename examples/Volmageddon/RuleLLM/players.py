...
from examples.Volmageddon.RuleLLM.prompts import format_user_prompt, get_prompt
from examples.Volmageddon.Rule.players import Market
...
class LLMShortVolTrader(LLMInvestor):
    """LLM-driven ShortVolTrader."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "short_vol_trader"

class LLMVolETNManager(LLMInvestor):
    """LLM-driven VolETNManager."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "vol_e_t_n_manager"

class LLMLongVolHedger(LLMInvestor):
    """LLM-driven LongVolHedger."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "long_vol_hedger"

class LLMVolArbitrageur(LLMInvestor):
    """LLM-driven VolArbitrageur."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "vol_arbitrageur"

class LLMEquityTrader(LLMInvestor):
    """LLM-driven EquityTrader."""
    
    def _initialize_investor_state(self) -> None:
        super()._initialize_investor_state()
        self.agent_type = "equity_trader"
