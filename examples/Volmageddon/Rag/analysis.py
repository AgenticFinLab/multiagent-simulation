...
02_volmageddon_analysis.png, 03_summary.png, and rag_stats.json.
"""
...
def analyze_rag_knowledge_effect(
    ...
    """Measure retrieval coverage for Volmageddon Rag runs."""
...
def main() -> Dict[str, Any]:
    ...
    parser = argparse.ArgumentParser(description="Analyze Volmageddon Rag simulation")
    parser.add_argument(
        "-c",
        "--config",
        type=str,
    ...
    summary = analyze_standard_scenario("Volmageddon", data, config, output_dir)
