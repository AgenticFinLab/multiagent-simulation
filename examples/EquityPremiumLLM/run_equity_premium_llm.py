...
Usage:
    python examples/EquityPremiumLLM/run_equity_premium_llm.py -c configs/EquityPremiumLLM/simulation.yml
"""
...
async def main():
    ...
    parser.add_argument(
        "-c", "--config", type=str, default="configs/EquityPremiumLLM/simulation.yml"
    )
