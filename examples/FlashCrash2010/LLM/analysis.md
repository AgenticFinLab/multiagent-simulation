# 2010 Flash Crash LLM Analysis Plan

## §1 Objectives

This analysis checks whether the LLM variant produces a complete, analyzable 2010 Flash Crash trajectory while preserving the class-mapped `agent_type` contract required by the order-book depth model.
...
Analysis is performed by round, by agent type, by market phase, and by variant. LLM-family review should additionally inspect parse failures, conservative liquidity defaults, and whether class-mapped HFT orders are present.
