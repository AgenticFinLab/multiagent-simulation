...
This analysis checks whether the Rag variant produces a complete, analyzable 2010 Flash Crash trajectory. It maps recorded price, fundamental, and volume series to the metric catalogue in `analysis-bases.md` and supports cross-variant comparison against the Rule baseline.
