...
| Domain      | finance                                                                                                                |
| Phenomenon  | Small-sample pattern matching causes agents to overgeneralize recent returns as regime shifts, creating excess demand. |
...
| bayesian-updater         | quantitatively disciplined institutional investor or rational analyst  | Base-Rate Neglect (§4.2)                                  | Stabilising       | price, fundamental, deviation | "Exists to update beliefs using full posterior probabilities and base rates, serving as the rationality benchmark." | masim/agents/defines/finance/rational-updater.md  |
| contrarian-statistical   | statistical arbitrage fund or quant mean-reversion strategist          | Regime Extrapolation (§4.3) corrective                    | Stabilising       | price, deviation              | "Exists to exploit representativeness-driven mispricing by trading toward statistical expectations."                | masim/agents/defines/finance/contrarian-trader.md |
